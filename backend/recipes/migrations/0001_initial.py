# Generated by Django 4.2.15 on 2024-09-30 18:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#ffffff', image_field=None, max_length=7, samples=None, unique=True, validators=[django.core.validators.RegexValidator(message='Некорректный формат', regex='^#([a-f0-9]{6}|[a-f0-9]{3})$')], verbose_name='Цвет')),
            ],
            options={
                'verbose_name': 'тег',
